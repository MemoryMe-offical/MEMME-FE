...
const styles = StyleSheet.create({
  ...
  divider: { height: 1, backgroundColor: '#E8EEF8', marginVertical: 12 },
  'content-input': {
    fontSize: 15,
    color: '#1A1A1A',
    fontFamily: 'PretendardVariable',
  ...
  'section-divider': { height: 1, backgroundColor: '#E8EEF8', marginTop: 16, marginBottom: 16 },
  'section-label': {
    fontSize: 12,
    fontWeight: '600',
    color: '#9DAFC8',
