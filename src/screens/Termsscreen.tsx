...
8. 회원 탈퇴 및 개인정보 삭제
이용자는 앱 내 설정 화면의 "회원 탈퇴" 메뉴를 통해 직접 회원 탈퇴 및 계정 삭제를 요청할 수 있습니다.

회원 탈퇴가 완료되면 관련 법령에 따라 보관이 필요한 정보를 제외하고 계정 정보 및 이용자가 저장한 콘텐츠를 삭제합니다.

다만, 관계 법령에 따라 보관이 필요한 정보는 해당 법령에서 정한 기간 동안 분리 보관 후 파기합니다.

앱 이용이 어렵거나 추가적인 개인정보 열람, 정정, 삭제, 처리정지 요청이 필요한 경우 개인정보 보호책임자 이메일을 통해 요청할 수 있습니다.
