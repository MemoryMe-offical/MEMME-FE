...
Memme(이하 "회사")는 이용자의 개인정보를 중요하게 생각하며, 「개인정보 보호법」 등 관련 법령을 준수하기 위해 다음과 같이 개인정보 처리방침을 수립·공개합니다.

1. 개인정보의 수집 및 이용 목적
회사는 다음의 목적을 위하여 개인정보를 처리합니다. 처리하고 있는 개인정보는 아래 목적 이외의 용도로는 이용되지 않으며, 이용 목적이 변경되는 경우에는 관련 법령에 따라 별도의 동의를 받는 등 필요한 조치를 이행합니다.
...
나. 소셜 로그인 이용 시 수집 항목
카카오 또는 애플 소셜 로그인을 이용하는 경우, 회사는 해당 소셜 로그인 제공자로부터 아래 정보를 제공받을 수 있습니다.
...
3. 개인정보의 보유 및 이용기간
회사는 법령에 따른 개인정보 보유·이용기간 또는 이용자로부터 개인정보를 수집할 때 동의받은 개인정보 보유·이용기간 내에서 개인정보를 처리하고 보유합니다.
...
4. 개인정보의 제3자 제공
회사는 이용자의 개인정보를 제1조에서 명시한 개인정보의 처리 목적 범위 내에서만 처리하며, 이용자의 동의가 있거나 법률에 특별한 규정이 있는 경우 등 관련 법령에서 허용하는 경우에만 개인정보를 제3자에게 제공합니다.

회사는 원칙적으로 이용자의 개인정보를 외부에 제공하지 않습니다. 다만, AI 요약 기능 제공 과정에서 이용자가 입력한 텍스트 또는 URL 정보가 AI 서비스 제공자에게 전송될 수 있습니다.
...
회사는 위탁계약 체결 시 개인정보가 안전하게 관리될 수 있도록 관련 법령에 따라 필요한 사항을 관리·감독합니다.

6. 개인정보의 국외 이전
회사는 AI 요약 서비스 제공을 위해 아래와 같이 개인정보가 국외로 이전될 수 있음을 고지합니다.
...
권리 행사는 개인정보 보호책임자 이메일을 통해 요청할 수 있으며, 회사는 관련 법령에 따라 지체 없이 조치합니다.

8. 회원 탈퇴 및 개인정보 삭제
이용자는 개인정보 보호책임자 이메일을 통해 회원 탈퇴 및 개인정보 삭제를 요청할 수 있습니다.

회사는 이용자의 요청을 확인한 후 본인 확인 절차를 거쳐 관련 법령에 따라 보관이 필요한 정보를 제외하고 개인정보를 삭제합니다.
...
회사는 현재 서비스 제공을 위해 쿠키 등 개인정보 자동 수집 장치를 별도로 운영하지 않습니다.
...
가. AI 요약 정확성
회사는 AI 요약 결과의 정확성, 완전성, 최신성을 보장하지 않습니다.
...
다. 서비스 품질 개선
회사는 개인을 식별할 수 없는 통계 정보에 한하여 서비스 품질 개선 및 안정적 운영을 위해 활용할 수 있습니다.

라. AI 서비스 제공자 변경
회사는 더 나은 서비스 제공을 위해 AI 서비스 제공자를 변경할 수 있으며, 변경이 필요한 경우 관련 법령 및 내부 정책에 따라 사전 공지합니다.
...
회사는 개인정보 처리방침을 변경하는 경우 서비스 내 공지사항 또는 별도 안내를 통해 변경 내용을 고지합니다.
