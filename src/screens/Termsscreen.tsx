...
제3조 (약관의 게시와 개정)
1. 운영팀은 본 약관의 내용을 이용자가 쉽게 알 수 있도록 서비스 초기 화면에 게시합니다.
2. 운영팀은 관련 법령을 위배하지 않는 범위에서 본 약관을 개정할 수 있습니다.
3. 약관이 개정되는 경우 운영팀은 개정 내용과 적용일자를 명시하여 서비스 내 공지사항을 통해 공지합니다.
...
1. 운영팀은 다음과 같은 서비스를 제공합니다.
   ...
   - 기타 운영팀이 정하는 부가 서비스
2. 운영팀은 서비스의 내용을 변경할 수 있으며, 변경 시 사전에 공지합니다.
...
3. 회원이 다음 각 호의 사유에 해당하는 경우, 운영팀은 회원자격을 제한 및 정지시킬 수 있습니다.
...
1. 회원은 다음 행위를 하여서는 안 됩니다.
   ...
   - 서비스를 통해 얻은 정보를 운영팀의 사전 승낙 없이 복제, 유통, 조장하거나 상업적으로 이용하는 행위

제11조 (저작권 및 AI 생성 콘텐츠)
1. 운영팀이 작성한 저작물에 대한 저작권 기타 지적재산권은 운영팀에 귀속합니다.
2. 이용자가 서비스에 게시한 채팅, 게시물 등의 저작권은 해당 이용자에게 귀속됩니다.
3. AI가 생성한 요약 콘텐츠는 운영팀과 이용자가 공동으로 사용할 수 있으며, 이용자는 해당 콘텐츠를 개인적 용도로 자유롭게 활용할 수 있습니다.
